#
# Module manifest for module 'posh-git-theme-bluelotus'
#
# Generated by: rkitover
#
...
GUID = '6e7e2810-3794-4a03-939e-5485fb4fd1fa'
...
VariablesToExport = @('gitprompt_theme_bluelotus')
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/rkitover/posh-git-theme-bluelotus'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/rkitover/posh-git-theme-bluelotus/blob/master/CHANGELOG.md'
